 ...
 * @author ASUS
 */
public class HomeTransporteurLibreController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            setLabelProfileTranspL();
        } catch (SQLException ex) {
            Logger.getLogger(HomeTransporteurLibreController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
    ...
    public void setLabelProfileTranspL() throws SQLException{
         String fullName="";
    ...
    void goToProfile(MouseEvent event){
      ...
      @FXML
      public void cc(MouseEvent event)
      {
          try {
               Node node = (Node) event.getSource();
                Stage stage = (Stage) node.getScene().getWindow();
